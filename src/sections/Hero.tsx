  ...
  return (
    <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
      <div className='absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]'>
        ...
        >
          <div
            className='size-2 rounded-full  text-emerald-300/20'
          />
        </HeroOrbit>
        <HeroOrbit
          size={530}
        ...
        <HeroOrbit 
          ...
          >
          <div 
            className='size-3 rounded-full  text-emerald-300/20' 
          />
        </HeroOrbit>
        <HeroOrbit 
          size={800} 
      ...
      <div className="container">
        <div className='flex flex-col items-center'>
          ...
          >
            ...
            >
              <div
                className='bg-green-500 absolute inset-0 rounded-full animate-ping-large'>
              </div>
            </div>
        ...
        >
          ...
          >
            I Specialize in transforming desings into functional, high performing web applications, Let's discuss your next project
          </p>
        </div>
        <div
