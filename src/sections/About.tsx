...
import mapImage from '@/assets/images/map-mumbai.png'
      ...
      <div className="mt-20 flex flex-col gap-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
          ...
          <Card className="h-[320px]  md:col-span-3 lg:col-span-2">
            <CardHeader
              title="My Toolbox"
              description="Explores the technologies and tools i use to craft exceptional digital experiences"
              className=""
            />
            <ToolboxItems
              items={toolboxItems}
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:grid-cols-3">
          ...
          <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
            ...
            >
              <div
                className="absolute inset-0 rounded-full bg-gradient-to-r bg-emerald-300  to-sky-400 -z-20 animate-ping [animation-duration:2s]"
              >
              </div>
              <div
                className="absolute inset-0 rounded-full bg-gradient-to-r bg-emerald-300  to-sky-400 -z-10"
              >
              </div>
              <Image
                src={smileMemoji}
